...
import {
  ...
  CreditCard, RefreshCw, Activity, ShoppingCart, LogOut, ChevronRight, DollarSign,
} from 'lucide-react';
...
const navGroups: { title: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { title: 'Products', url: '/products', icon: ShoppingCart, roles: [UserRole.ADMIN] },
    ],
  },
  {
    title: 'Governance',
    items: [
      { title: 'Approvals', url: '/approvals', icon: CheckSquare, roles: [UserRole.ADMIN, UserRole.SALES_MANAGER, UserRole.FINANCE_OPS] },
      { title: 'Deal Health', url: '/deal-health', icon: Activity, roles: [UserRole.ADMIN, UserRole.SALES_MANAGER, UserRole.FINANCE_OPS] },
    ],
  },
  {
    title: 'Operations',
  ...
  },
  {
    title: 'Insights',
    items: [
      { title: 'Reports', url: '/reports', icon: BarChart3, roles: ALL_INTERNAL },
    ],
  },
];
